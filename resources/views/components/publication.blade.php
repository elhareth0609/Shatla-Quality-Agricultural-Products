...
<div id="carouselExampleDark{{ $publication->id }}" class="carousel carousel-light slide carousel-fade col-md-4 mb-2 rounded" data-bs-ride="carousel" style="height: 400px">
  ...
  <div class="carousel-inner h-100 rounded">
    ...
    <div class="carousel-item justify-content-center bg-black d-flex h-100 position-relative {{ $key == 0 ? 'active' : '' }}">
      ...
      <img class="img-fluid position-absolute h-100 rounded-0" src="{{ $photo->photoUrl() }}" alt="{{ $photo->id }}">
      <img class="img-fluid w-100 h-100 rounded" src="{{ $photo->photoUrl() }}" alt="{{ $photo->id }}">
