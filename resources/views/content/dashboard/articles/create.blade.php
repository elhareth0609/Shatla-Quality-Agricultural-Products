...
@section('content')
<h4 class="py-3 mb-4" dir="{{ app()->isLocale('ar') ? 'rtl' : '' }}"><span class="text-muted fw-light">{{ __('Pages') }} /</span> {{ __('Create New Article') }}
</h4>
...
<div class="row">
  <div class="card mb-4 pb-4">
    ...
    <form id="contentForm" method="POST" action="{{ route('article.create') }}" enctype="multipart/form-data">
      <div class="card-body">
          ...
          <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
            ...
            <div class="card-body">
              <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src="{{asset('assets/img/photos/articles/default.png')}}" alt="user-avatar" class="d-block rounded" id="uploadedAvatar" style="width: 340px!important;height: 180px!important"/>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-floating form-floating-outline">
                <select id="types" name="type" class="form-select">
            ...
            <div class="col-md-6 mb-3">
              <div class="form-floating form-floating-outline">
                <select id="diseaes" name="disease" class="form-select">
...
<script type="text/javascript">
    ...
    var myDropzone = new Dropzone("#dropzone", {
        ...
        this.on("complete", function(file) {
            // Redirect to the articles URL after all files have been uploaded
