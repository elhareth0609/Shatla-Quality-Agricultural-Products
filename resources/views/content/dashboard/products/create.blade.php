          ...
          <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
            ...
            <div class="card-body">
              <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src="{{asset('assets/img/illustrations/In-sync-rafiki.png')}}" alt="user-avatar" class="d-block rounded" id="uploadedAvatar" style="width: 170px!important;height: 180px!important"/>
