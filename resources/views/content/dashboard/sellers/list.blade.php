...
@section('content')
<h4 class="py-3 mb-4" dir="{{ app()->isLocale('ar') ? 'rtl' : '' }}"><span class="text-muted fw-light">{{ __('Pages') }} /</span> {{ __('Sellers') }}
</h4>

<!-- Responsive Table -->
<div class="card row" dir="{{ app()->isLocale('ar') ? 'rtl' : '' }}">
  <h5 class="card-header">{{ __('Sellers') }}</h5>
  <div class="row">
  ...
  <div class="table-responsive text-nowrap">
    <table class="table table-striped w-100" id="sellers" data-page-length='100'>
      <thead>
