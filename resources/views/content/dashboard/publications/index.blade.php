...
@section('title', __('Update Publication'))
...
@section('content')
<h4 class="py-3 mb-4" dir="{{ app()->isLocale('ar') ? 'rtl' : '' }}"><span class="text-muted fw-light">{{ __('Pages') }} /</span> {{ $publication->title }}
</h4>
...
<div class="row">
  <div class="card mb-4 pb-4">
    ...
    <form id="contentForm" method="POST" action="{{ route('publication.update') }}" enctype="multipart/form-data">
      <div class="card-body">
          ...
          <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
            ...
            {{-- <div class="card-body">
              <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src="{{ $blog->photoUrl() }}" alt="user-avatar" class="d-block rounded" id="uploadedAvatar" style="width: 340px!important;height: 180px!important"/>
            ...
            <div class="row d-flex">
              ...
              <div class="col-md-6 mb-3">
                <div class="form-floating form-floating-outline">
                  <input type="text" class="form-control" id="address" name="title" placeholder="{{ __('Title') }}" value="{{ $publication->title }}" />
                ...
                <div class="form-floating form-floating-outline">
                  <select id="subcategory" name="subcategory" class="form-select">
                    @foreach ($subcategorys as $subcategory)
                      @if ($subcategory->id === $blog->subcategory->id)
              ...
              <div class="col-md-12 mb-3">
                  <textarea name="content" id="content">{{ $publication->content }}</textarea>
              </div>

              <div class="col-md-6 mb-3">
                <div class="input-group">
                  <span class="input-group-text">{{ __('Tags') }}</span>
                  <textarea class="form-control" id="tags" name="tags" aria-label="With textarea">{{ is_array($publication->tags) ? implode(', ', $publication->tags) : htmlspecialchars($publication->tags) }}</textarea>
                </textarea>
                </div>
              </div>
