...
@section('title', __('Create New Publication'))
...
@section('content')
<h4 class="py-3 mb-4" dir="{{ app()->isLocale('ar') ? 'rtl' : '' }}"><span class="text-muted fw-light">{{ __('Pages') }} /</span> {{ __('Create New Publication') }}
</h4>
...
<div class="row">
  <div class="card mb-4 pb-4">
    ...
    <form id="contentForm" method="POST" action="{{ route('publication.create') }}" enctype="multipart/form-data">
      <div class="card-body">
...
<script type="text/javascript">
    ...
    function uploadFiles(publicationId) {
