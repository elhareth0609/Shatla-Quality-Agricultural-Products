...
@section('content')
<h4 class="py-3 mb-4" dir="{{ app()->isLocale('ar') ? 'rtl' : '' }}"><span class="text-muted fw-light">{{ __('Pages') }} /</span> {{ $blog->title }}
</h4>
...
<div class="row">
  <div class="card mb-4 pb-4">
    ...
    <form id="contentForm" method="POST" action="{{ route('blog.update') }}" enctype="multipart/form-data">
      <div class="card-body">
            ...
            <div class="row d-flex">
              ...
              <div class="col-md-6 mb-3">
                <div class="form-floating form-floating-outline">
                  <input type="text" class="form-control" id="address" name="title" placeholder="{{ __('Title') }}" value="{{ $blog->title }}" />
              ...
              <div class="col-md-6 mb-3">
                <div class="input-group">
                  ...
                  <textarea class="form-control" id="tags" name="tags" aria-label="With textarea">{{ is_array($blog->tags) ? implode(', ', $blog->tags) : htmlspecialchars($blog->tags) }}</textarea>
                </textarea>
                </div>
              </div>
            ...
            <div class="photos-container">
              @foreach ($blog->photos as $photo)
                <div class="image-container text-center my-w-fit-content mb-2 mx-auto position-relative">
                    ...
                    <img src="{{ $photo->photoUrl() }}" alt="{{ $photo->id }}" class="rounded blog-photo" />
                </div>
              @endforeach
            </div>
          </div>
