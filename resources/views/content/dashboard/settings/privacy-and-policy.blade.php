...
@section('content')
<h4 class="py-3 mb-4" dir="{{ app()->isLocale('ar') ? 'rtl' : '' }}"><span class="text-muted fw-light">{{ __('Pages') }} /</span> {{ __('Privacy & Policy') }}
</h4>

<form id="contentForm" method="POST" action="{{ route('privacy_and_policy.update') }}">
  @csrf
